...
app.get('/api/instagram', async (req, res) => {
    try {
        ...
        const instagramUrl = `https://graph.instagram.com/me/media?fields=thumbnail_url,media_type,media_url,caption,permalink,username,id&limit=8&access_token=${token}`;
